...
K = add_element(K, 1, E, L1, 0, 5, 3); % link 1
K = add_element(K, 1, E, L1, 0, 3, 1); % link 2
K = add_element(K, 1, E, L1, 0, 6, 4); % link 3
K = add_element(K, 1, E, L1, 0, 4, 2); % link 4

K = add_element(K, 1, E, L1, 90, 4, 3); % link 5
K = add_element(K, 1, E, L1, 90, 2, 1); % link 6

K_temp = K*A1;

K = zeros(nodes*2, nodes*2);

K = add_element(K, 1, E, L2, -45, 5, 4); % link 7
K = add_element(K, 1, E, L2, -45, 3, 2); % link 9

K = add_element(K, 1, E, L2, 45, 6, 3); % link 8
K = add_element(K, 1, E, L2, 45, 4, 1); % link 10
